...
export default function Home() {
  return (
    <main className="flex flex-row flex-1 h-full w-full items-end gap-2 overflow-x-scroll">
      <AnimalGraphic imagePath={`${basePath}/images/blue-whale.jpg`} sketchHeightPx={800} sketchAspectRatio="640 / 427" />
      <AnimalGraphic imagePath={`${basePath}/images/blue-whale.jpg`} sketchHeightPx={700} sketchAspectRatio="640 / 427" />
      <AnimalGraphic imagePath={`${basePath}/images/blue-whale.jpg`} sketchHeightPx={400} sketchAspectRatio="640 / 427" />
      <AnimalGraphic imagePath={`${basePath}/images/blue-whale.jpg`} sketchHeightPx={300} sketchAspectRatio="640 / 427" />
